...
Shows Slack notifications in the top right that stack and slide up
"""
...
class SlackNotification:
    ...
    def render(self, screen, x, y, width):
        ...
        # Draw border (Slack purple)
        pygame.draw.rect(notification, (74, 21, 75), 
                        pygame.Rect(0, 0, width, height), 2)
        
        # Draw Slack icon (simple purple square)
        icon_size = 20
        icon_x = padding
        ...
        # Channel name
        channel_text = font_title.render(self.channel, True, (0, 0, 0))
...
class SlackNotificationSystem:
    ...
    def _add_notification(self):
        ...
        timestamp = time.time()
        notification = SlackNotification(channel, user, message, timestamp)
